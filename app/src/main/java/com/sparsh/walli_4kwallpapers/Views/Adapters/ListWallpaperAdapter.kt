...
class ListWallpaperAdapter(private var ListWallpaperList: MutableList<Wallpaper>) :
    RecyclerView.Adapter<ListWallpaperAdapter.WallpaperViewHolder>() {
    ...
    override fun onBindViewHolder(holder: WallpaperViewHolder, position: Int) {
        val wallpaper = ListWallpaperList[position]
